 ...
 *
 * Dashboard kuesioner yang sudah ada menjawab "bagaimana hasilnya"; halaman ini
 * menjawab pertanyaan yang berbeda dan lebih sering ditanyakan procurement:
 * **siapa yang belum mengisi**. Karena itu barisnya adalah pemasok, bukan
 * respons, dan pemasok yang belum ditugaskan sama sekali tetap muncul —
 * justru merekalah yang paling mudah terlewat.
 */
export default function QuestionnaireCompliance() {
  ...
  return (
    <>
      <PageHeader
        trail={[{ label: 'Beranda', to: '/internal/beranda' }, { label: 'Kepatuhan kuesioner' }]}
        icon="verify"
        title="Kepatuhan pengisian kuesioner"
        description="Siapa yang sudah dan belum mengisi kuesioner yang ditugaskan. Saring per kuesioner untuk menemukan pemasok yang tertinggal."
      />
